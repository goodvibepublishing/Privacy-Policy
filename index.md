...
- **Journal Entries** — Text you write within the App is stored **locally on your device only** using an on-device SQLite database. We do not transmit or store your journal entries on our servers except as described in Section 2.
...
When you choose to use the **✨ AI Insights** feature:

- The text of the specific journal entry you are viewing is **transmitted to our secure server** (hosted on Google Firebase Cloud Functions) solely to generate an AI-powered response.
- Our server processes your text using **Anthropic's Claude AI model** to generate a personalised, compassionate insight.
- Your journal text is **not stored, logged, or retained** on our servers after the AI response is returned to your device.
- The AI-generated response is displayed to you in the App and is **not stored on our servers**.
- This feature is **opt-in** — your text is only transmitted when you explicitly tap the AI Insights button.

### 2.1 Third-Party AI Processing
By using the AI Insights feature, your journal text is processed by **Anthropic, PBC**. Anthropic processes this data in accordance with their own privacy policy and data usage policies. We encourage you to review:
...
For users in the **European Economic Area (EEA)** or **California (CCPA)**, you have additional rights under GDPR and CCPA respectively. Please contact us to exercise these rights.
...
**Good Vibe Publishing**
Email: [goodvibepublishing@gmail.com]
Website: [https://goodvibepublishing.github.io/Privacy-Policy/](https://goodvibepublishing.github.io/Privacy-Policy/)
